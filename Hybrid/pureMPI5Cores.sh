...
# Number of MPI tasks
#SBATCH -n 5  # 5 -> 1/4 nodes

module load gcc openmpi
export OMP_NUM_THREADS=1 

echo 160 particles, 5 processes, 1 thread 
mpirun ./nBody 160 200 1e-3 0 -x OMP_NUM_THREADS

echo 320 particles, 5 processes, 1 thread 
mpirun ./nBody 320 200 1e-3 0 -x OMP_NUM_THREADS

echo 640 particles, 5 processes, 1 thread 
mpirun ./nBody 640 200 1e-3 0 -x OMP_NUM_THREADS

echo 1280 particles, 5 processes, 1 thread 
mpirun ./nBody 1280 200 1e-3 0 -x OMP_NUM_THREADS

echo 2560 particles, 5 processes, 1 thread 
mpirun ./nBody 2560 200 1e-3 0 -x OMP_NUM_THREADS

echo 5120 particles, 5 processes, 1 thread 
mpirun ./nBody 5120 200 1e-3 0 -x OMP_NUM_THREADS

echo 10240 particles, 5 processes, 1 thread 
